...
app.get('/',function(req,res,next){
    res.render('index',{title:'hello',user:{name:'zxmf'}});
});
app.listen(3000);
```


### 5.2 渲染函数 [#](#t105.2 渲染函数)
