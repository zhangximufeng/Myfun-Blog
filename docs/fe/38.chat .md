...
6\. 编写房间列表 [#](#t136. 编写房间列表)
-----------------------------

### 6.1 聊天房间组件 [#](#t146.1 聊天房间组件)
                ...
                <Layout.Content>
                    <Row>
                        <Col offset={2} span={20}>
                            ...
                            >
                                <List
                                    header={<div style={{ textAlign: 'center' }}>欢迎来到沐枫聊天室</div>}
                                    size="large"
                                    bordered={false}
